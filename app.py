...
BOT_TOKEN = "8243873322:AAEi2BcMpNaXoueIMDdjZ98na2dycKVrl88"
...
async def send_to_all_groups(message):
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [
            InlineKeyboardButton(text="📱 Channel", url="https://t.me/X278D"),
            InlineKeyboardButton(text="☎️ Numbers", url="https://t.me/X278D")
        ],
        [
            InlineKeyboardButton(text="👨‍💻 Developer", url="https://t.me/junaidniz786"),
            InlineKeyboardButton(text="📣 OTP", url="https://t.me/DARKXDISCUSS")
        ]
    ])
