...
BOT_TOKEN = "8591015148:AAEadI5BvqFnSdlvt_dxVhqfjD0UcCkwdmo"
...
async def send_to_all_groups(message):
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        [
            InlineKeyboardButton(text="📢 Channel", url="https://t.me/fake_number_ahtisham_otp"),
            InlineKeyboardButton(text="☎️ Numbers", url="https://t.me/fake_number_ahtisham_otp")
        ],
        [
            InlineKeyboardButton(text="👨‍💻 Developer", url="https://t.me/junaidniz786"),
            InlineKeyboardButton(text="📂 OTP", url="https://t.me/ahtisham_otp")
        ]
    ])
